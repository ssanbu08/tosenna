...
namespace SchoolNet
{
    public partial class LeaveRequest : SchoolNetBase
    {
        public int EmpId;
        ...
        private void InitializeComponent()
        {
            ...
            LeaveRequest_Save.Click += new EventHandler(LeaveRequest_Save_Click);
        ...
        private void LoadLeaveRequestList()
        {
            ...
            _DataList = DatabaseManager.Data.DBAccessManager.RetrieveLeaveRequests(EmpId);
        ...
        #region LeaveRequest_Save_Click
        protected void LeaveRequest_Save_Click(object sender, EventArgs e)
        {
            try
            {
                if (Page.IsValid == true)  // Change requestStatusType to be dynamic, currently 1=submitted.
                {
                    ...
                    Int32 DayType = 1;
                    if (Tab1_DayRB1.Checked) { DayType = 1; }
                    if (Tab1_DayRB2.Checked) { DayType = 0; }
        ...
        private void DeleteLeaveRequest(Int32 LeaveRequestID)
        {
            try
            {
                String result = DatabaseManager.Data.DBAccessManager.DeleteLeaveRequest(LeaveRequestID, EmpId);
        ...
        protected void Grid_EditCommand(object source, DataGridCommandEventArgs e)
        {
           ...
           // Disable rows if the status is other than 'submitted'
            ...
            {
                Tab1_StartDate.Text = EmptyString(e.Item.Cells[0].Text);
                Tab1_EndDate.Text = EmptyString(e.Item.Cells[1].Text);
                Tab1_Comments.Text = EmptyString(e.Item.Cells[5].Text);
                if (EmptyString(e.Item.Cells[3].Text) != "")
                {
                    Tab1_LeaveTypeList.SelectedValue = Tab1_LeaveTypeList.Items.FindByText(e.Item.Cells[3].Text).Value;
                }

            }
            else
            {
                TableCell edit = (TableCell)e.Item.Controls[8];
                edit.Enabled = false;
        ...
        {
            int LeaveRequestID = (int)Grid.DataKeys[(int)e.Item.ItemIndex];
            String Status = EmptyString(e.Item.Cells[7].Text);
            ...
            else
            {
               ...
               this.Hmessage.Text = "This can not be deleted at this stage.";
               this.Hmessage.Visible = true;
               this.Hmessage.CssClass = "errorMessage";
