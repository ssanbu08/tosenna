		...
		public sealed class DBAccessManager
		{
         ...
         //   See the sample method to just execute but no need to return data back.
            ...
            public static String AddNewEmployee(Int32 SalutationTypeID, String FName, String MidName, String LName, String DOB, Int32 GenderTypeID, Int32 MaritalStatusID, String HireDate, String EmployeeID, Int32 EmpCategory, Int32 JobCategory, Int32 EmpStatusID, Int32 DesignationID, Int32 DepartmentID, Int32 DivisionID, Int32 EducationID, Int32 PhotoProfile, String PhotoPath, String UserName, String Password, Int32 LocationID, Int32 Probation, String PSEmployeeID, String Home_Addr1, String Home_Addr2, String City, String Home_State, Int32 Home_CountryID, String Work_Addr1, String Work_Addr2, String Work_City, String Work_State, Int32 Work_CountryID, String Home_Phone, String Mobile_Phone, String Work_Phone, String Work_Email, Int32 SupervisorID, Int32 AccessLevelID, Int32 AddedBy_ID, Int32 AccountStatus)
            {
                ...
                parameters[10] = new SqlParameter("@JobCategory", SqlDbType.Int);
                parameters[10].Value = JobCategory;

                parameters[11] = new SqlParameter("@EmpStatusID", SqlDbType.Int);
                parameters[11].Value = EmpStatusID;

                parameters[12] = new SqlParameter("@DesignationID", SqlDbType.Int);
                parameters[12].Value = DesignationID;

                parameters[13] = new SqlParameter("@DepartmentID", SqlDbType.Int);
                parameters[13].Value = DepartmentID;

                parameters[14] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[14].Value = DivisionID;

                parameters[15] = new SqlParameter("@EducationID", SqlDbType.Int);
                parameters[15].Value = EducationID;

                parameters[16] = new SqlParameter("@PhotoProfile", SqlDbType.Int);
                parameters[16].Value = PhotoProfile;

                parameters[17] = new SqlParameter("@PhotoPath", SqlDbType.VarChar,100);
                parameters[17].Value = PhotoPath;

                parameters[18] = new SqlParameter("@UserName", SqlDbType.VarChar,50);
                parameters[18].Value = UserName;

                parameters[19] = new SqlParameter("@Password", SqlDbType.VarChar,50);
                parameters[19].Value = Password;

                parameters[20] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[20].Value = LocationID;

                parameters[21] = new SqlParameter("@Probation", SqlDbType.Int);
                parameters[21].Value = Probation;

                parameters[22] = new SqlParameter("@PSEmployeeID", SqlDbType.VarChar,30);
                parameters[22].Value = PSEmployeeID;

                parameters[23] = new SqlParameter("@Home_Addr1", SqlDbType.VarChar, 50);
                parameters[23].Value = Home_Addr1;

                parameters[24] = new SqlParameter("@Home_Addr2", SqlDbType.VarChar, 50);
                parameters[24].Value = Home_Addr2;

                parameters[25] = new SqlParameter("@City", SqlDbType.VarChar, 50);
                parameters[25].Value = City;

                parameters[26] = new SqlParameter("@State", SqlDbType.VarChar, 50);
                parameters[26].Value = Home_State;

                parameters[27] = new SqlParameter("@Home_CountryID", SqlDbType.Int);
                parameters[27].Value = Home_CountryID;

                parameters[28] = new SqlParameter("@Work_Addr1", SqlDbType.VarChar, 50);
                parameters[28].Value = Work_Addr1;

                parameters[29] = new SqlParameter("@Work_Addr2", SqlDbType.VarChar, 50);
                parameters[29].Value = Work_Addr2;

                parameters[30] = new SqlParameter("@Work_City", SqlDbType.VarChar, 50);
                parameters[30].Value = Work_City;

                parameters[31] = new SqlParameter("@Work_State", SqlDbType.VarChar, 50);
                parameters[31].Value = Work_State;

                parameters[32] = new SqlParameter("@Work_CountryID", SqlDbType.Int);
                parameters[32].Value = Work_CountryID;

                parameters[33] = new SqlParameter("@Home_Phone", SqlDbType.VarChar, 20);
                parameters[33].Value = Home_Phone;

                parameters[34] = new SqlParameter("@Mobile_Phone", SqlDbType.VarChar, 20);
                parameters[34].Value = Mobile_Phone;

                parameters[35] = new SqlParameter("@Work_Phone", SqlDbType.VarChar, 20);
                parameters[35].Value = Work_Phone;

                parameters[36] = new SqlParameter("@Work_Email", SqlDbType.VarChar, 50);
                parameters[36].Value = Work_Email;

                parameters[37] = new SqlParameter("@SupervisorID", SqlDbType.Int);
                parameters[37].Value = SupervisorID;

                parameters[38] = new SqlParameter("@AccessLevelID", SqlDbType.Int);
                parameters[38].Value = AccessLevelID;

                parameters[39] = new SqlParameter("@AddedBy_ID", SqlDbType.Int);
                parameters[39].Value = AddedBy_ID;

                parameters[40] = new SqlParameter("@AccountStatus", SqlDbType.Int);
                parameters[40].Value = AccountStatus;
          ...
          #region AddUpdateEmployeeDeductions
           ...
           public static String DeleteEmployeeDependent(Int32 EmpId, Int32 DependentID)
            ...
            #region RetrieveBreedType
            public static NamedCollection[] RetrieveBreedType()
            {

                return RetrieveCollection("spGetBreedType", null);

            }
            #endregion

            #region RetrieveAnimalGroup
            public static NamedCollection[] RetrieveAnimalGroup()
            {

                return RetrieveCollection("spGetAnimalGroup", null);

            }
            #endregion

            #region RetrieveAnimalLocation
            public static NamedCollection[] RetrieveAnimalLocation()
            {

                return RetrieveCollection("spGetAnimalLocation", null);

            }
            #endregion

            #region AddUpdateCattle
            public static String AddUpdateCattle(Int32 AnimalID, String AnimalName, String ShortName, String AnimalTagID, Int32 GroupID, Int32 StatusTypeID, Int32 BreedTypeID, String MicrochipID,
                Int32 AssignedTrainerID, Int32 AssignedVetID, Int32 FarmLocationID, Int32 GenderTypeID, String BirthDate, Int32 BornOutside, Double BirthWeight, Double BirthHeight, Int32 MaleParent, Int32 FemaleParent, String AnimalColor, String AdoptedDate, String DisplacedDate, String Notes, Int32 Edited_ID)
            {

                SqlParameter[] parameters = new SqlParameter[23];

                parameters[0] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[0].Value = AnimalID;

                parameters[1] = new SqlParameter("@AnimalName", SqlDbType.VarChar, 100);
                parameters[1].Value = AnimalName;

                parameters[2] = new SqlParameter("@ShortName", SqlDbType.VarChar, 50);
                parameters[2].Value = ShortName;

                parameters[3] = new SqlParameter("@AnimalTagID", SqlDbType.VarChar, 50);
                parameters[3].Value = AnimalTagID;

                parameters[4] = new SqlParameter("@GroupID", SqlDbType.Int);
                parameters[4].Value = GroupID;

                parameters[5] = new SqlParameter("@StatusTypeID", SqlDbType.Int);
                parameters[5].Value = StatusTypeID;

                parameters[6] = new SqlParameter("@BreedTypeID", SqlDbType.Int);
                parameters[6].Value = BreedTypeID;

                parameters[7] = new SqlParameter("@MicrochipID", SqlDbType.VarChar, 50);
                parameters[7].Value = MicrochipID;

                parameters[8] = new SqlParameter("@AssignedTrainerID", SqlDbType.Int);
                parameters[8].Value = AssignedTrainerID;

                parameters[9] = new SqlParameter("@AssignedVetID", SqlDbType.Int);
                parameters[9].Value = AssignedVetID;

                parameters[10] = new SqlParameter("@FarmLocationID", SqlDbType.Int);
                parameters[10].Value = FarmLocationID;

                parameters[11] = new SqlParameter("@GenderTypeID", SqlDbType.Int);
                parameters[11].Value = GenderTypeID;

                parameters[12] = new SqlParameter("@BirthDate", SqlDbType.VarChar, 30);
                parameters[12].Value = BirthDate;

                parameters[13] = new SqlParameter("@BornOutside", SqlDbType.Int);
                parameters[13].Value = BornOutside;

                parameters[14] = new SqlParameter("@BirthWeight", SqlDbType.Float);
                parameters[14].Value = BirthWeight;

                parameters[15] = new SqlParameter("@BirthHeight", SqlDbType.Float);
                parameters[15].Value = BirthHeight;

                parameters[16] = new SqlParameter("@MaleParent", SqlDbType.Int);
                parameters[16].Value = MaleParent;

                parameters[17] = new SqlParameter("@FemaleParent", SqlDbType.Int);
                parameters[17].Value = FemaleParent;

                parameters[18] = new SqlParameter("@AnimalColor", SqlDbType.VarChar, 50);
                parameters[18].Value = AnimalColor;

                parameters[19] = new SqlParameter("@AdoptedDate", SqlDbType.VarChar, 30);
                parameters[19].Value = AdoptedDate;

                parameters[20] = new SqlParameter("@DisplacedDate", SqlDbType.VarChar, 30);
                parameters[20].Value = DisplacedDate;

                parameters[21] = new SqlParameter("@Notes", SqlDbType.VarChar, 250);
                parameters[21].Value = Notes;

                parameters[22] = new SqlParameter("@Edited_ID", SqlDbType.Int);
                parameters[22].Value = Edited_ID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateAnimalProfile", parameters);
            }
            #endregion

            #region RetrieveCattleList_Search
            public static DataSet RetrieveCattleList_Search(String CattleTagId, String CattleName, Int32 CattleGroup, Int32 BreedType, Int32 CattleStatus, Int32 DivisionID, Int32 LocationID, Int32 VeterinaryID, Int32 TrainerID, Int32 RequestorEmpID)
            {
                SqlParameter[] parameters = new SqlParameter[10];
                parameters[0] = new SqlParameter("@CattleTagId", SqlDbType.VarChar, 50);
                parameters[0].Value = CattleTagId;
                parameters[1] = new SqlParameter("@CattleName", SqlDbType.VarChar, 100);
                parameters[1].Value = CattleName;
                parameters[2] = new SqlParameter("@CattleGroup", SqlDbType.VarChar, 30);
                parameters[2].Value = CattleGroup;
                parameters[3] = new SqlParameter("@BreedType", SqlDbType.Int);
                parameters[3].Value = BreedType;
                parameters[4] = new SqlParameter("@CattleStatus", SqlDbType.Int);
                parameters[4].Value = CattleStatus;
                parameters[5] = new SqlParameter("@DivisionID", SqlDbType.Int);
                parameters[5].Value = DivisionID;
                parameters[6] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[6].Value = LocationID;
                parameters[7] = new SqlParameter("@VeterinaryID", SqlDbType.Int);
                parameters[7].Value = VeterinaryID;
                parameters[8] = new SqlParameter("@TrainerID", SqlDbType.Int);
                parameters[8].Value = TrainerID;
                parameters[9] = new SqlParameter("RequestorEmpID", SqlDbType.Int);
                parameters[9].Value = RequestorEmpID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetCattleList_Search", parameters);
                return dataSet;

            }
            #endregion  

            #region RetrieveCattleStatus
            public static NamedCollection[] RetrieveCattleStatus()
            {

                return RetrieveCollection("spGetStatusType_LK", null);

            }
            #endregion

            #region RetrieveLocationType
            public static NamedCollection[] RetrieveLocationType()
            {

                return RetrieveCollection("spLocationType_LK", null);
            }
            #endregion

            #region RetrieveCattleLocationLookup
            public static NamedCollection[] RetrieveCattleLocationLookup(Int32 LocType)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@LocType", SqlDbType.Int);
                parameters[0].Value = LocType;
                return RetrieveCollection("spGetCattleLocationLookup", parameters);

            }
            #endregion

            #region RetrieveCattleListByStatusMenu
            public static DataSet RetrieveCattleListByStatusMenu(Int32 CattleStatus, Int32 RequestorEmpID)
            {
                SqlParameter[] parameters = new SqlParameter[2];
                parameters[0] = new SqlParameter("@CattleStatus", SqlDbType.Int);
                parameters[0].Value = CattleStatus;
                parameters[1] = new SqlParameter("@RequestorEmpID", SqlDbType.Int);
                parameters[1].Value = RequestorEmpID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetCattleListByStatusMenu", parameters);
                return dataSet;
            }
            #endregion  

            #region RetrieveCattleInfo
            public static DataSet RetrieveCattleInfo(Int32 AnimalID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[0].Value = AnimalID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetCattleInfo", parameters);
                return dataSet;
            }
            #endregion  

            #region RetrieveJobCategoryLookup
            public static NamedCollection[] RetrieveJobCategoryLookup()
            {
                return RetrieveCollection("spGetJobCategoryLookup", null);

            }
            #endregion

            #region RetrieveEmployeeListByStatusMenu
            public static DataSet RetrieveEmployeeListByStatusMenu(Int32 EmpStatusID, Int32 RequestorEmpID)
            {
                SqlParameter[] parameters = new SqlParameter[2];
                parameters[0] = new SqlParameter("@EmpStatusID", SqlDbType.Int);
                parameters[0].Value = EmpStatusID;
                parameters[1] = new SqlParameter("@RequestorEmpID", SqlDbType.Int);
                parameters[1].Value = RequestorEmpID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetEmployeeList_Search", parameters);
                return dataSet;
            ...
            #region RetrieveVeternerianLookup
            public static NamedCollection[] RetrieveVeternerianLookup()
            {
                return RetrieveCollection("spGetVeternerianLookup", null);

            }
            #endregion

            #region RetrieveTrainerLookup
            public static NamedCollection[] RetrieveTrainerLookup()
            {
                return RetrieveCollection("spGetTrainerLookup", null);

            }
            #endregion

            #region RetrieveLabTestList
            public static DataSet RetrieveLabTestList()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetLabtestsList", parameters);
                return dataSet;
            }
            #endregion


            #region AddUpdateLabTestCodes
            public static String AddUpdateLabTestCodes(Int32 LabtestCodeID, String Labtestcode, String TestDescription, Int32 LabTestType, Int32 Status)
            {
                SqlParameter[] parameters = new SqlParameter[5];

                parameters[0] = new SqlParameter("@LabtestCodeID", SqlDbType.Int);
                parameters[0].Value = LabtestCodeID;

                parameters[1] = new SqlParameter("@Labtestcode", SqlDbType.VarChar, 10);
                parameters[1].Value = Labtestcode;

                parameters[2] = new SqlParameter("@TestDescription", SqlDbType.VarChar, 150);
                parameters[2].Value = TestDescription;

                parameters[3] = new SqlParameter("@LabTestType", SqlDbType.Int);
                parameters[3].Value = LabTestType;

                parameters[4] = new SqlParameter("@Status", SqlDbType.Int);
                parameters[4].Value = Status;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateLabtestCodes", parameters);
            }
            #endregion

            #region RetrieveVaccinesList
            public static DataSet RetrieveVaccinesList()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetVaccinesList", parameters);
                return dataSet;
            }
            #endregion


            #region AddUpdateVaccines
            public static String AddUpdateVaccines(Int32 VaccineID, String VaccineName, Int32 DiseaseID, Int32 VaccineMethod, Int32 FirstVaccination, Int32 BoosterDose, Int32 RevaccinationType, String Remarks, String TradeName, Int32 Dose, Int32 UOMTypeID, Int32 IsActive, Int32 UpdatedBy)
            {
                SqlParameter[] parameters = new SqlParameter[13];

                parameters[0] = new SqlParameter("@VaccineID", SqlDbType.Int);
                parameters[0].Value = VaccineID;

                parameters[1] = new SqlParameter("@VaccineName", SqlDbType.VarChar, 70);
                parameters[1].Value = VaccineName;

                parameters[2] = new SqlParameter("@DiseaseID", SqlDbType.Int);
                parameters[2].Value = DiseaseID;

                parameters[3] = new SqlParameter("@VaccineMethod", SqlDbType.Int);
                parameters[3].Value = VaccineMethod;

                parameters[4] = new SqlParameter("@FirstVaccination", SqlDbType.Int);
                parameters[4].Value = FirstVaccination;

                parameters[5] = new SqlParameter("@BoosterDose", SqlDbType.Int);
                parameters[5].Value = BoosterDose;

                parameters[6] = new SqlParameter("@RevaccinationType", SqlDbType.Int);
                parameters[6].Value = RevaccinationType;

                parameters[7] = new SqlParameter("@Remarks", SqlDbType.VarChar, 250);
                parameters[7].Value = Remarks;

                parameters[8] = new SqlParameter("@TradeName", SqlDbType.VarChar, 100);
                parameters[8].Value = TradeName;

                parameters[9] = new SqlParameter("@Dose", SqlDbType.Int);
                parameters[9].Value = Dose;

                parameters[10] = new SqlParameter("@UOMTypeID", SqlDbType.Int);
                parameters[10].Value = UOMTypeID;

                parameters[11] = new SqlParameter("@IsActive", SqlDbType.Int);
                parameters[11].Value = IsActive;

                parameters[12] = new SqlParameter("@UpdatedBy", SqlDbType.Int);
                parameters[12].Value = UpdatedBy;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateVaccine", parameters);
            }
            #endregion


            #region RetrieveDiseasesLookup
            public static NamedCollection[] RetrieveDiseasesLookup()
            {
                return RetrieveCollection("spGetDiseases_LK", null);

            }
            #endregion

            #region RetrieveVaccinationMethodLookup
            public static NamedCollection[] RetrieveVaccinationMethodLookup()
            {
                return RetrieveCollection("spGetVaccinationMethod_LK", null);

            }
            #endregion

            #region RetrieveTimePeriodLookup
            public static NamedCollection[] RetrieveTimePeriodLookup()
            {
                return RetrieveCollection("spGetTimePeriod_LK", null);

            }
            #endregion

            #region RetrieveUOMTypeLookup
            public static NamedCollection[] RetrieveUOMTypeLookup()
            {
                return RetrieveCollection("spGetUOM_LK", null);

            }
            #endregion


            #region RetrieveLabTestsLookup
            public static NamedCollection[] RetrieveLabTestsLookup()
            {
                return RetrieveCollection("spGetLabtestCode_LK", null);

            }
            #endregion

            #region RetrieveVaccinesLookup
            public static NamedCollection[] RetrieveVaccinesLookup()
            {
                return RetrieveCollection("spGetVaccine_LK", null);

            }
            #endregion


            #region AddUpdateCattleLabTests
            public static String AddUpdateCattleLabTests(Int32 ID, Int32 AnimalID, Int32 LabTestCodeID, String LabTestRefCode, String LabTestDate, String LabNotes, Int32 VetID, Int32 EditedID)
            {
                SqlParameter[] parameters = new SqlParameter[8];
                ...
                parameters[1] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[1].Value = AnimalID;

                parameters[2] = new SqlParameter("@LabTestCodeID", SqlDbType.Int);
                parameters[2].Value = LabTestCodeID;

                parameters[3] = new SqlParameter("@LabTestRefCode", SqlDbType.VarChar, 50);
                parameters[3].Value = LabTestRefCode;

                parameters[4] = new SqlParameter("@LabTestDate", SqlDbType.VarChar, 30);
                parameters[4].Value = LabTestDate;

                parameters[5] = new SqlParameter("@LabNotes", SqlDbType.VarChar, 150);
                parameters[5].Value = LabNotes;

                parameters[6] = new SqlParameter("@VetID", SqlDbType.Int);
                parameters[6].Value = VetID;

                parameters[7] = new SqlParameter("@EditedID", SqlDbType.Int);
                parameters[7].Value = EditedID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateLabTests", parameters);
            }
            #endregion

            #region RetrieveCattleLabTests
            public static DataSet RetrieveCattleLabTests(Int32 AnimalID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[0].Value = AnimalID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetCattleLabTests", parameters);
                return dataSet;
            }
            #endregion  

            #region AddUpdateCattleVaccinations
            public static String AddUpdateCattleVaccinations(Int32 ID, Int32 AnimalID, Int32 VaccineID, String VaccinationDate, String NextVaccineDueDate, String Notes, Int32 EditedID)
            {
                SqlParameter[] parameters = new SqlParameter[7];
                ...
                parameters[2] = new SqlParameter("@VaccineID", SqlDbType.Int);
                parameters[2].Value = VaccineID;

                parameters[3] = new SqlParameter("@VaccinationDate", SqlDbType.VarChar, 30);
                parameters[3].Value = VaccinationDate;

                parameters[4] = new SqlParameter("@NextVaccineDueDate", SqlDbType.VarChar, 30);
                parameters[4].Value = NextVaccineDueDate;

                parameters[5] = new SqlParameter("@Notes", SqlDbType.VarChar, 150);
                parameters[5].Value = Notes;

                parameters[6] = new SqlParameter("@EditedID", SqlDbType.Int);
                parameters[6].Value = EditedID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateVaccineHistory", parameters);
            }
            #endregion

            #region RetrieveCattleVaccinations
            public static DataSet RetrieveCattleVaccinations(Int32 AnimalID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[0].Value = AnimalID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetCattleVaccinations", parameters);
                return dataSet;
            }
            #endregion  

            #region RetrievePharmacyMasterList
            public static DataSet RetrievePharmacyMasterList()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetPharmacyMasterList", parameters);
                return dataSet;
            }
            #endregion


            #region AddUpdatePharmacyItemMaster
            public static String AddUpdatePharmacyItemMaster(Int32 PharmacyItemID, String ItemName, String ItemCode, String ItemDescription, Int32 ItemType, Int32 UnitWeight, Int32 UoMTypeID, Int32 MinStockLevel, Int32 MaxStockLevel, Int32 ReorderLevel, Int32 IsLiquid, Int32 IsActive, Int32 EditedID)
            {
                SqlParameter[] parameters = new SqlParameter[13];

                parameters[0] = new SqlParameter("@PharmacyItemID", SqlDbType.Int);
                parameters[0].Value = PharmacyItemID;

                parameters[1] = new SqlParameter("@ItemName", SqlDbType.VarChar, 100);
                parameters[1].Value = ItemName;

                parameters[2] = new SqlParameter("@ItemCode", SqlDbType.VarChar, 50);
                parameters[2].Value = ItemCode;

                parameters[3] = new SqlParameter("@ItemDescription", SqlDbType.VarChar, 50);
                parameters[3].Value = ItemDescription;

                parameters[4] = new SqlParameter("@ItemType", SqlDbType.Int);
                parameters[4].Value = ItemType;

                parameters[5] = new SqlParameter("@UnitWeight", SqlDbType.Int);
                parameters[5].Value = UnitWeight;

                parameters[6] = new SqlParameter("@UoMTypeID", SqlDbType.Int);
                parameters[6].Value = UoMTypeID;

                parameters[7] = new SqlParameter("@MinStockLevel", SqlDbType.Int);
                parameters[7].Value = MinStockLevel;

                parameters[8] = new SqlParameter("@MaxStockLevel", SqlDbType.Int);
                parameters[8].Value = MaxStockLevel;

                parameters[9] = new SqlParameter("@ReorderLevel", SqlDbType.Int);
                parameters[9].Value = ReorderLevel;

                parameters[10] = new SqlParameter("@IsLiquid", SqlDbType.Int);
                parameters[10].Value = IsLiquid;

                parameters[11] = new SqlParameter("@IsActive", SqlDbType.Int);
                parameters[11].Value = IsActive;

                parameters[12] = new SqlParameter("@EditedID", SqlDbType.Int);
                parameters[12].Value = EditedID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdatePharmacyItemMaster", parameters);
            }
            #endregion

            #region RetrieveDrugTypeLookup
            public static NamedCollection[] RetrieveDrugTypeLookup()
            {
                return RetrieveCollection("spGetDrugType_LK", null);

            }
            #endregion

            #region RetrievePharmacyItemLookup
            public static NamedCollection[] RetrievePharmacyItemLookup()
            {
                return RetrieveCollection("spGetPharmacyItem_LK", null);

            }
            #endregion

            #region RetrievePharmacyPurchaseList
            public static DataSet RetrievePharmacyPurchaseList()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetPharmacyPurchaseList", parameters);
                return dataSet;
            }
            #endregion

            #region AddUpdatePharmacyPurchase
            public static String AddUpdatePharmacyPurchase(Int32 ID, Int32 PharmacyItemID, String BillReference, String PurchaseDate, Int32 Qty, Double UnitPrice, String ExpiryDate, String Notes, Int32 EditedID)
            {
                SqlParameter[] parameters = new SqlParameter[9];
                ...
                parameters[1] = new SqlParameter("@PharmacyItemID", SqlDbType.Int);
                parameters[1].Value = PharmacyItemID;

                parameters[2] = new SqlParameter("@BillReference", SqlDbType.VarChar, 50);
                parameters[2].Value = BillReference;

                parameters[3] = new SqlParameter("@PurchaseDate", SqlDbType.VarChar, 30);
                parameters[3].Value = PurchaseDate;

                parameters[4] = new SqlParameter("@Qty", SqlDbType.Int);
                parameters[4].Value = Qty;

                parameters[5] = new SqlParameter("@UnitPrice", SqlDbType.Float);
                parameters[5].Value = UnitPrice;

                parameters[6] = new SqlParameter("@ExpiryDate", SqlDbType.VarChar, 30);
                parameters[6].Value = ExpiryDate;

                parameters[7] = new SqlParameter("@Notes", SqlDbType.VarChar, 150);
                parameters[7].Value = Notes;

                parameters[8] = new SqlParameter("@EditedID", SqlDbType.Int);
                parameters[8].Value = EditedID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdatePharmacyItemPurchaseHistory", parameters);
            }
            #endregion

            #region RetrievePharmacyStockList
            public static DataSet RetrievePharmacyStockList()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetPharmacyStockList", parameters);
                return dataSet;
            }
            #endregion

            #region RetrievePharmacyStockHistory
            public static DataSet RetrievePharmacyStockHistory(Int32 PharmacyItemID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@PharmacyItemID", SqlDbType.Int);
                parameters[0].Value = PharmacyItemID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetPharmacyStockHistory", parameters);
                return dataSet;
            }
            #endregion  

            #region RetrieveTreatmentTypeLookup
            public static NamedCollection[] RetrieveTreatmentTypeLookup()
            {
                return RetrieveCollection("spGetTreatmentType_LK", null);
            ...
            #region AddUpdateCattleTreatments
            public static String AddUpdateCattleTreatments(Int32 ID, Int32 AnimalID, String PrescriptionID, Int32 TreatmentTypeID, String TreatmentDate, Int32 DiseaseID, String CaseDescription, String Findings, String Treatment, String ClinicalRelevance, String FollowupDate, Int32 AssignedVetID, Int32 LocationID, Int32 FollowupAlert, Int32 Edited_ID)
            {
                SqlParameter[] parameters = new SqlParameter[15];
                ...
                parameters[2] = new SqlParameter("@PrescriptionID", SqlDbType.VarChar, 20);
                parameters[2].Value = PrescriptionID;

                parameters[3] = new SqlParameter("@TreatmentTypeID", SqlDbType.Int);
                parameters[3].Value = TreatmentTypeID;

                parameters[4] = new SqlParameter("@TreatmentDate", SqlDbType.VarChar, 30);
                parameters[4].Value = TreatmentDate;

                parameters[5] = new SqlParameter("@DiseaseID", SqlDbType.Int);
                parameters[5].Value = DiseaseID;

                parameters[6] = new SqlParameter("@CaseDescription", SqlDbType.VarChar, 150);
                parameters[6].Value = CaseDescription;

                parameters[7] = new SqlParameter("@Findings", SqlDbType.VarChar, 250);
                parameters[7].Value = Findings;

                parameters[8] = new SqlParameter("@Treatment", SqlDbType.VarChar, 250);
                parameters[8].Value = Treatment;

                parameters[9] = new SqlParameter("@ClinicalRelevance", SqlDbType.VarChar, 250);
                parameters[9].Value = ClinicalRelevance;

                parameters[10] = new SqlParameter("@FollowupDate", SqlDbType.VarChar, 30);
                parameters[10].Value = FollowupDate;

                parameters[11] = new SqlParameter("@AssignedVetID", SqlDbType.Int);
                parameters[11].Value = AssignedVetID;

                parameters[12] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[12].Value = LocationID;

                parameters[13] = new SqlParameter("@FollowupAlert", SqlDbType.Int);
                parameters[13].Value = FollowupAlert;

                parameters[14] = new SqlParameter("@Edited_ID", SqlDbType.Int);
                parameters[14].Value = Edited_ID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateCattleTreatments", parameters);
            }
            #endregion

            #region RetrieveCattleTreatments
            public static DataSet RetrieveCattleTreatments(Int32 AnimalID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[0].Value = AnimalID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetCattleTreatments", parameters);
                return dataSet;
            }
            #endregion  

            #region RetrieveCattleDrugsUsage
            public static DataSet RetrieveCattleDrugsUsage(Int32 CattleTreatmentID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@CattleTreatmentID", SqlDbType.Int);
                parameters[0].Value = CattleTreatmentID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetCattleDrugsUsageByTreatmentID", parameters);
                return dataSet;
            }
            #endregion 
 
            #region AddUpdateCattleDrugsUsage
            public static String AddUpdateCattleDrugsUsage(Int32 UsageID, Int32 CattleTreatmentID, Int32 PharmacyItemID, Int32 Quantity, String ShortNotes, Int32 EditedID)
            {
                SqlParameter[] parameters = new SqlParameter[6];
                ...
                parameters[1] = new SqlParameter("@CattleTreatmentID", SqlDbType.Int);
                parameters[1].Value = CattleTreatmentID;

                parameters[2] = new SqlParameter("@PharmacyItemID", SqlDbType.Int);
                parameters[2].Value = PharmacyItemID;

                parameters[3] = new SqlParameter("@Quantity", SqlDbType.Int);
                parameters[3].Value = Quantity;

                parameters[4] = new SqlParameter("@ShortNotes", SqlDbType.VarChar, 150);
                parameters[4].Value = ShortNotes;

                parameters[5] = new SqlParameter("@EditedID", SqlDbType.Int);
                parameters[5].Value = EditedID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateCattleDrugsUsage", parameters);
            }
            #endregion

            #region DeleteCattleDrugsUsage
            public static String DeleteCattleDrugsUsage(Int32 CattleTreatmentID, Int32 UsageID, Int32 RequestingEmpId)
            {
                ...
                parameters[0] = new SqlParameter("@CattleTreatmentID", SqlDbType.Int);
                parameters[0].Value = CattleTreatmentID;
                parameters[1] = new SqlParameter("@UsageID", SqlDbType.Int);
                parameters[1].Value = UsageID;
                parameters[2] = new SqlParameter("@RequestingEmpId", SqlDbType.Int);
                parameters[2].Value = RequestingEmpId;

                return BaseDataAccessor.ExecuteWithResult("spDeleteCattleDrugsUsage", parameters);
            }
            #endregion

            #region RetrieveCattleDocumentTypeLookup
            public static NamedCollection[] RetrieveCattleDocumentTypeLookup()
            {
                return RetrieveCollection("spGetCattleDocumentType_LK", null);
            }
            #endregion

            #region AddCattleDocuments
            public static String AddCattleDocuments(Int32 AnimalID, Int32 DocumentTypeID, String DocumentName, String Document_Location, String Doc_Comments)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spAddCattleDocument", parameters);
            }
            #endregion


            #region DeleteCattleDocument
            public static String DeleteCattleDocument(Int32 AnimalID, Int32 DocumentId)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeleteCattleDocument", parameters);
            }
            #endregion

            #region RetrieveCattleDocuments
            public static DataSet RetrieveCattleDocuments(Int32 AnimalID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[0].Value = AnimalID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetCattleDocuments", parameters);
                return dataSet;
            }
            #endregion  

            #region RetrieveMaleParentLookup
            public static NamedCollection[] RetrieveMaleParentLookup(String DOB)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@DOB", SqlDbType.VarChar, 30);
                parameters[0].Value = DOB;
                return RetrieveCollection("spGetMaleParentLookup", parameters);

            }
            #endregion

            #region RetrieveFemaleParentLookup
            public static NamedCollection[] RetrieveFemaleParentLookup(String DOB)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@DOB", SqlDbType.VarChar, 30);
                parameters[0].Value = DOB;
                return RetrieveCollection("spGetFemaleParentLookup", parameters);

            }
            #endregion

            #region RetrieveDashboardData
            public static DataSet RetrieveDashboardData()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetDashboardData", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveDashboardBarchartData
            public static DataSet RetrieveDashboardBarchartData()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetDashboardBarChart", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveChartDailyDrugsConsumed
            public static DataSet RetrieveChartDailyDrugsConsumed()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetDashboardBarChart2", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveRaceEventsLookup
            public static NamedCollection[] RetrieveRaceEventsLookup()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                return RetrieveCollection("spGetRaceEvents_LK", parameters);
            }
            #endregion

            #region RetrieveRacePlaceTypeLookup
            public static NamedCollection[] RetrieveRacePlaceTypeLookup()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                return RetrieveCollection("spGetRacePlaceType_LK", parameters);
            }
            #endregion


            #region AddUpdateRaceEvents
            public static String AddUpdateRaceEvents(Int32 RaceID, String RaceName, String RaceDescription, String RaceOrganiser, Int32 LocationID, String RaceSchedule, String RaceStartTime, String RaceEndTime, Int32 Distance, Int32 BreedTypeID, Int32 CattleCatagory, Int32 FirstPrize, Int32 SecondPrize, Int32 ThirdPrize, Int32 FourthPrize, Int32 FivthPrize, Int32 SixthPrize, Int32 SeventhPrize, Int32 EditedID)
            {

                SqlParameter[] parameters = new SqlParameter[19];

                parameters[0] = new SqlParameter("@RaceID", SqlDbType.Int);
                parameters[0].Value = RaceID;

                parameters[1] = new SqlParameter("@RaceName", SqlDbType.VarChar, 100);
                parameters[1].Value = RaceName;

                parameters[2] = new SqlParameter("@RaceDescription", SqlDbType.VarChar, 250);
                parameters[2].Value = RaceDescription;

                parameters[3] = new SqlParameter("@RaceOrganiser", SqlDbType.VarChar, 100);
                parameters[3].Value = RaceOrganiser;

                parameters[4] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[4].Value = LocationID;

                parameters[5] = new SqlParameter("@RaceSchedule", SqlDbType.VarChar, 50);
                parameters[5].Value = RaceSchedule;

                parameters[6] = new SqlParameter("@RaceStartTime", SqlDbType.VarChar, 30);
                parameters[6].Value = RaceStartTime;

                parameters[7] = new SqlParameter("@RaceEndTime", SqlDbType.VarChar, 30);
                parameters[7].Value = RaceEndTime;

                parameters[8] = new SqlParameter("@Distance", SqlDbType.Int);
                parameters[8].Value = Distance;
                parameters[9] = new SqlParameter("@BreedTypeID", SqlDbType.Int);
                parameters[9].Value = BreedTypeID;
                parameters[10] = new SqlParameter("@CattleCatagory", SqlDbType.Int);
                parameters[10].Value = CattleCatagory;
                parameters[11] = new SqlParameter("@FirstPrize", SqlDbType.Int);
                parameters[11].Value = FirstPrize;
                parameters[12] = new SqlParameter("@SecondPrize", SqlDbType.Int);
                parameters[12].Value = SecondPrize;
                parameters[13] = new SqlParameter("@ThirdPrize", SqlDbType.Int);
                parameters[13].Value = ThirdPrize;
                parameters[14] = new SqlParameter("@FourthPrize", SqlDbType.Int);
                parameters[14].Value = FourthPrize;
                parameters[15] = new SqlParameter("@FivthPrize", SqlDbType.Int);
                parameters[15].Value = FivthPrize;
                parameters[16] = new SqlParameter("@SixthPrize", SqlDbType.Int);
                parameters[16].Value = SixthPrize;
                parameters[17] = new SqlParameter("@SeventhPrize", SqlDbType.Int);
                parameters[17].Value = SeventhPrize;
                parameters[18] = new SqlParameter("@EditedID", SqlDbType.Int);
                parameters[18].Value = EditedID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateRaceEvents", parameters);
            }
            #endregion

            #region AddUpdateCattleRaceSampling
            public static String AddUpdateCattleRaceSampling(Int32 SampleID, Int32 AnimalID, Int32 TrainerID, Int32 RaceID, Int32 LocationID, Int32 TrailID, String StartTime, String Duration, Int32 PlaceTypeID, Double MaximumLength, Double CMaximumLength, Int32 EditedID)
            {

                SqlParameter[] parameters = new SqlParameter[12];

                parameters[0] = new SqlParameter("@SampleID", SqlDbType.Int);
                parameters[0].Value = SampleID;

                parameters[1] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[1].Value = AnimalID;

                parameters[2] = new SqlParameter("@TrainerID", SqlDbType.Int);
                parameters[2].Value = TrainerID;

                parameters[3] = new SqlParameter("@RaceID", SqlDbType.Int);
                parameters[3].Value = RaceID;

                parameters[4] = new SqlParameter("@LocationID", SqlDbType.Int);
                parameters[4].Value = LocationID;

                parameters[5] = new SqlParameter("@TrailID", SqlDbType.Int);
                parameters[5].Value = TrailID;

                parameters[6] = new SqlParameter("@StartTime", SqlDbType.VarChar, 50);
                parameters[6].Value = StartTime;

                parameters[7] = new SqlParameter("@Duration", SqlDbType.VarChar, 30);
                parameters[7].Value = Duration;

                parameters[8] = new SqlParameter("@PlaceTypeID", SqlDbType.Int);
                parameters[8].Value = PlaceTypeID;

                parameters[9] = new SqlParameter("@MaximumLength", SqlDbType.Int);
                parameters[9].Value = MaximumLength;

                parameters[10] = new SqlParameter("@CMaximumLength", SqlDbType.VarChar, 100);
                parameters[10].Value = CMaximumLength;

                parameters[11] = new SqlParameter("@EditedID", SqlDbType.Int);
                parameters[11].Value = EditedID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateRaceSampling", parameters);
            }
            #endregion

            #region AddUpdateCattleRaceResults
            public static String AddUpdateCattleRaceResults(Int32 ID, Int32 AnimalID, Int32 TrainerID, Int32 RaceID, String Duration, Int32 PlaceTypeID, Int32 EditedID)
            {
                ...
                parameters[4] = new SqlParameter("@Duration", SqlDbType.VarChar, 30);
                parameters[4].Value = Duration;

                parameters[5] = new SqlParameter("@PlaceTypeID", SqlDbType.Int);
                parameters[5].Value = PlaceTypeID;

                parameters[6] = new SqlParameter("@EditedID", SqlDbType.Int);
                parameters[6].Value = EditedID;

                return BaseDataAccessor.ExecuteWithResult("spAddUpdateRaceEventResults", parameters);
            }
            #endregion

            #region RetrieveRaceEventsList
            public static DataSet RetrieveRaceEventsList()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetRaceEventsList", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveRaceSamplingList
            public static DataSet RetrieveRaceSamplingList()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetRaceSamplingList", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveRaceEventResultsList
            public static DataSet RetrieveRaceEventResultsList()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetRaceEventResultsList", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveRaceCattlesLookup
            public static NamedCollection[] RetrieveRaceCattlesLookup()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                return RetrieveCollection("spGetRaceCattles_LK", parameters);
            }
            #endregion

            #region RetrieveTrainerIDByCattle
            public static Int32 RetrieveTrainerIDByCattle(Int32 AnimalID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                ...
                return BaseDataAccessor.ExecuteFunctionReturnsInt("dbo.udf_GetCattleTrainerID", parameters);
            }
            #endregion

            #region RetrieveLocationIDByRaceID
            public static Int32 RetrieveLocationIDByRaceID(Int32 RaceID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                ...
                return BaseDataAccessor.ExecuteFunctionReturnsInt("dbo.udf_GetLocationIDByRaceID", parameters);
            }
            #endregion


            #region RetrieveRaceStatistics
            public static DataSet RetrieveRaceStatistics()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetRaceStatisticsList", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveRaceResultsByCattleID
            public static DataSet RetrieveRaceResultsByCattleID(Int32 AnimalID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@AnimalID", SqlDbType.Int);
                parameters[0].Value = AnimalID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetRaceResultsByCattleID", parameters);
                return dataSet;
            }
            #endregion  

            #region RetrieveRacesPastWeekLookup
            public static NamedCollection[] RetrieveRacesPastWeekLookup()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                return RetrieveCollection("spGetRaceEventsPastweek_LK", parameters);
            }
            #endregion

            #region RetrieveRaceTrainerStatistics
            public static DataSet RetrieveRaceTrainerStatistics()
            {
                SqlParameter[] parameters = new SqlParameter[0];
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("[spGetRaceTrainerStatisticsList]", parameters);
                return dataSet;
            }
            #endregion

            #region RetrieveRaceResultsByTrainerID
            public static DataSet RetrieveRaceResultsByTrainerID(Int32 TrainerID)
            {
                SqlParameter[] parameters = new SqlParameter[1];
                parameters[0] = new SqlParameter("@TrainerID", SqlDbType.Int);
                parameters[0].Value = TrainerID;
                DataSet dataSet = BaseDataAccessor.ExecuteDataSet("spGetRaceResultsByTrainerID", parameters);
                return dataSet;
            }
            #endregion  

            #region DeleteRaceSampling
            public static String DeleteRaceSampling(Int32 SampleID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeleteRaceSampling", parameters);
            }
            #endregion

            #region DeleteRaceEventResults
            public static String DeleteRaceEventResults(Int32 ID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeleteRaceEventResults", parameters);
            }
            #endregion

            #region DeleteRaceEvents
            public static String DeleteRaceEvents(Int32 RaceID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("spDeleteRaceEvents", parameters);
            }
            #endregion

            #region DeleteCattleLabTests
            public static String DeleteCattleLabTests(Int32 AnimalID, Int32 ID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("[spDeleteCattleLabTests]", parameters);
            }
            #endregion

            #region DeleteCattleVaccinations
            public static String DeleteCattleVaccinations(Int32 AnimalID, Int32 ID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("[spDeleteCattleVaccinations]", parameters);
            }
            #endregion

            #region DeleteCattleTreatments
            public static String DeleteCattleTreatments(Int32 AnimalID, Int32 ID)
            {
                ...
                return BaseDataAccessor.ExecuteWithResult("[spDeleteCattleTreatments]", parameters);
            }
            #endregion
