    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        private void Change_Password_Click(object sender, System.EventArgs e)
        {
            try
            {
                if (Tab1_password.Text.ToString() != Tab1_NewPassword.Text.ToString())
                {
                        ...
                        if (Result == "")
                        {
                            Login_Pane.Visible = true;
                            ChangePassword.Visible = false;
                            this.errorMessage2.Text = "";

                        }
                        else
                        {
                            this.errorMessage2.Text = Result;
                            this.errorMessage2.CssClass = "validationtxt2";
                        }
            ...
            catch (Exception exception)
            {
                ...
                this.errorMessage2.Visible = true;
                this.errorMessage2.Text = ErrorLogging.LogError(exception, "Unknown Exception Occured.Please contact Support.");
                this.errorMessage2.CssClass = "validationtxt2";
            }
        ...
        private void SignMeUp_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                if (Page.IsValid == true)
                {
                    ...
                    if (result == "")
                    {
                        this.errorMessage3.Visible = true;
                        this.Signup_EmployeeID.Text = "";
                        this.Signup_UserName.Text = "";
                        this.Signup_Password.Text = "";
                        this.errorMessage3.Text = "Thank you for sign up.Your account has been created. Please click the login link below to sign in.";
                        this.errorMessage3.CssClass = "validationtxt2";
                    ...
                    else
                    {
                        ...
                        this.errorMessage3.Text = result;
                        this.errorMessage3.CssClass = "validationtxt2";
                    }
                }
            }
            catch (Exception exception)
            {
                ...
                this.EmailAddress.Text = "";
                this.Login_Password.Text = "";
                this.errorMessage3.Text = ErrorLogging.LogError(exception, "Unknown Exception Occured.Please contact Support.");
                this.errorMessage3.CssClass = "validationtxt2";
            }
            ...
            try
            {
                if (Page.IsValid == true)
                {
                    ...
                    if (_DataList.Tables.Count > 0)
                    {
                        ...
                        {
                            this.errorMessage2.Visible = true;
                            this.errorMessage2.Text = "Sorry, We could not find your email address.Please check your email address again.";
                            this.errorMessage2.CssClass = "validationtxt2";
        ...
        private void SendPasswordRetrieveMail(string employeeName,string uName, string Employee_EmailAddress, string Password)
        {
            ...
            try
            {
                ...
                smtp.Send(message);
                this.errorMessage2.Visible = true;
                this.errorMessage2.Text = "Your login credentials have been sent to your work email account on our system.";
                this.errorMessage2.CssClass = "validationtxt2";
            ...
            {
                this.errorMessage2.Visible = true;
                this.errorMessage2.Text = ErrorLogging.LogError(exception, "There was an error in sending email notification.");
                this.errorMessage2.CssClass = "validationtxt2";
